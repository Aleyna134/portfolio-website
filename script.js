const translations = {
    tr: {
        ...
        proj_ci_desc: "GitHub repository’lerindeki kod değişikliklerini otomatik algılayarak build, test ve pipeline süreçlerini yöneten bir CI otomasyon sistemi geliştirildi.",
    ...
    en: {
        ...
        proj_ci_desc: "Developed a CI automation system that automatically detects code changes in GitHub repositories and manages build, test, and pipeline processes.",
        proj1_title: "PromptGuard – LLM Security Gateway",
